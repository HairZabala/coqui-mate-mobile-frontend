...
const AppTextInput = forwardRef<TextInput, AppTextInputProps & TextInputProps>(
  ({ style, containerStyle, error = false, highlightOnFocus, SuffixComponent, ...otherProps }, ref) => {
    ...
    return (
      <View
        style={[styles.container, containerStyle, showHighlight ? styles.highlight : {}, error ? styles.error : {}]}>
        <TextInput
          ref={ref}
          style={[styles.input, style, showHighlight ? styles.inputHighlight : styles.nonHighlightMarginAdjustment]}
          placeholderTextColor={otherProps.placeholderTextColor ?? theme.colors.black}
