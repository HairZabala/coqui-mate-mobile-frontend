...
import Permissions, { Permission, PermissionStatus } from 'react-native-permissions';
...
const usePermissionStatus: (permission: Permission) => [
  ...
  const [checkingPermissionStatus, setCheckingPermissionStatus] = useState<boolean>(true);
  ...
  return [permissionStatus, { loading: checkingPermissionStatus, check: checkPermission, request: requestPermission }];
};
